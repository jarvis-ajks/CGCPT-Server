...
run('curl -s -o /dev/null -w "JS: %{http_code} %{size_download}" http://127.0.0.1/CGCPT/assets/index-CfCqO3cC.js')
run('curl -s -o /dev/null -w "CSS: %{http_code} %{size_download}" http://127.0.0.1/CGCPT/assets/index-BqpHRU_p.css')
run('curl -s -o /dev/null -w "SVG: %{http_code} %{size_download}" http://127.0.0.1/CGCPT/favicon.svg')
run('curl -s -o /dev/null -w "Icons: %{http_code} %{size_download}" http://127.0.0.1/CGCPT/icons.svg')
run('curl -s -o /dev/null -w "SPA route: %{http_code} %{size_download}" http://127.0.0.1/CGCPT/materials')
