...
# Test API
code, r = run(
    "curl -s http://localhost/CGCPT/api/stats | python3 -c 'import sys,json; d=json.load(sys.stdin); print(f\"OK: {d.get(chr(116)+chr(111)+chr(116)+chr(97)+chr(108)+chr(95)+chr(109)+chr(97)+chr(116)+chr(101)+chr(114)+chr(105)+chr(97)+chr(108)+chr(115))} materials\")'"
)
print(f"API: {r}")
