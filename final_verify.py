...
tests = [
    ...
    (
        "JS Bundle",
        'curl -s -o /dev/null -w "%{http_code}" http://118.31.164.41/CGCPT/assets/index-CfCqO3cC.js',
    ),
    (
        "CSS Bundle",
    ...
    (
        "API Classifications",
        'curl -s -o /dev/null -w "%{http_code}" http://118.31.164.41/CGCPT/api/classifications',
    ),
    (
        "API Lattice Types",
        'curl -s -o /dev/null -w "%{http_code}" http://118.31.164.41/CGCPT/api/lattice-types',
    ),
    (
        "SPA Route /materials",
    ...
    (
        "SPA Route /generate",
        'curl -s -o /dev/null -w "%{http_code}" http://118.31.164.41/CGCPT/generate',
    ),
    (
        "SPA Route /compare",
