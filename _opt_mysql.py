...
print("\n=== MySQL config ===")
code, r = run(
    "cat /etc/mysql/mysql.conf.d/mysqld.cnf 2>/dev/null | grep -v '^#' | grep -v '^$' | head -30"
)
print(r)
...
print("\n=== Key MySQL variables ===")
code, r = run(
    "mysql -e \"SHOW VARIABLES LIKE 'innodb_buffer_pool_size'; SHOW VARIABLES LIKE 'max_connections'; SHOW VARIABLES LIKE 'table_open_cache'; SHOW VARIABLES LIKE 'thread_cache_size';\" 2>/dev/null"
)
print(r)
