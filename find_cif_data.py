...
out, _ = run('find / -maxdepth 4 -type d \\( -name "*XO*" -o -name "*Proto*" -o -name "*cif*" -o -name "*CIF*" -o -name "*stacking*" -o -name "*database*" -o -name "*train*" -o -name "*data*" \\) 2>/dev/null | grep -v proc | grep -v sys | head -30')
print(f"数据相关目录:\n{out if out else '无'}\n")
