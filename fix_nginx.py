...
run(
    'curl -s -o /dev/null -w "JS: %{http_code} %{size_download} bytes" http://118.31.164.41/CGCPT/assets/index-CfCqO3cC.js'
)
run(
    'curl -s -o /dev/null -w "CSS: %{http_code} %{size_download} bytes" http://118.31.164.41/CGCPT/assets/index-BqpHRU_p.css'
)
run(
    'curl -s -o /dev/null -w "SVG: %{http_code} %{size_download} bytes" http://118.31.164.41/CGCPT/favicon.svg'
)
run(
    'curl -s -o /dev/null -w "Page: %{http_code} %{size_download} bytes" http://118.31.164.41/CGCPT/'
)
